...
![](./markdown_pictures/rebase_4)

当'mywork'分支更新之后，它会指向这些新创建的提交(commit),而那些老的提交会被丢弃。 如果运行垃圾收集命令(pruning garbage collection), 这些被丢弃的提交就会删除.

![](./markdown_pictures/rebase_5)
...
![](./markdown_pictures/rebase_6)

![](./markdown_pictures/rebase_7)
